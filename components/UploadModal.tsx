...
import { X, Film, Image as ImageIcon, Loader2, Cloud, Terminal, Link as LinkIcon, FileUp, Save, Copy, CheckCircle2, ShieldAlert, Tag, Plus, Trash2, ListFilter, ExternalLink, Sparkles, RefreshCw, Layers, LayoutGrid, FileVideo, PlusCircle, ClipboardList, Camera, Upload } from 'lucide-react';
          ...
          {!isEditMode && (
            <div className="flex bg-white/5 p-1 rounded-2xl border border-white/10 self-start md:self-center">
              <button 
                ...
                className={`flex items-center space-x-3 px-8 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${uploadMode === 'single' ? 'bg-white text-black shadow-xl scale-105' : 'text-gray-500 hover:text-white'}`}
              >
              ...
              <button 
                ...
                className={`flex items-center space-x-3 px-8 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${uploadMode === 'bulk' ? 'bg-white text-black shadow-xl scale-105' : 'text-gray-500 hover:text-white'}`}
              >

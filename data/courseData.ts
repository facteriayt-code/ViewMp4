...
export const DAYS_CURRICULUM: DayLesson[] = [
  {
    ...
    "theory": {
      ...
      "wordExplanations": [
        {
          "word": "an apple",
          "role": "Indefinite Article + Singular Countable Noun",
          "whyUsed": "\"An\" is used because \"apple\" starts with the vowel sound /æ/. It introduces one non-specific apple."
        },
        {
          "word": "the sun",
          "role": "Definite Article + Unique Noun",
          "whyUsed": "\"The\" is required because there is only one sun in our solar system; both speaker and listener know exactly which sun."
        },
        {
          "word": "music",
          "role": "Uncountable Abstract Noun",
          "whyUsed": "No article is used here because \"music\" is an uncountable general concept."
        }
      ],
  ...
  },
  {
    ...
    "theory": {
      ...
      "wordExplanations": [
        {
          "word": "everyone has",
          "role": "Indefinite Pronoun + Singular Third-Person Verb",
          "whyUsed": "\"Everyone\" considers all members individually, requiring singular \"has\"."
        },
        {
          "word": "neither... is",
          "role": "Correlative Conjunction + Singular Verb",
          "whyUsed": "When \"neither/nor\" joins singular nouns, the subject is strictly singular."
        }
      ],
  ...
  },
  {
    ...
    "theory": {
      ...
      "wordExplanations": [
        {
          "word": "is raining",
          "role": "Present Continuous (be + present participle)",
          "whyUsed": "Emphasizes an ongoing action taking place right now at this exact moment."
        },
        {
          "word": "understands",
          "role": "Stative Verb in Present Simple",
          "whyUsed": "\"Understand\" is a mental state, not an active physical motion, so continuous -ing is avoided."
        }
      ],
      ...
      "wordPairs": [
        {
          "id": "p1",
          "word": "Believe",
          "definitionOrSynonym": "Stative Verb (Mental State)",
          "whyItMatters": "Cannot use \"-ing\": \"I believe you\" (NOT \"I am believing you\")."
        },
        {
          "id": "p2",
          "word": "Run",
          "definitionOrSynonym": "Dynamic Action Verb",
          "whyItMatters": "Can use continuous: \"He is running in the park right now.\""
        },
        {
          "id": "p3",
          "word": "Own",
          "definitionOrSynonym": "Stative Verb (Possession)",
          "whyItMatters": "States ownership: \"She owns a car\" (NOT \"She is owning a car\")."
        }
      ]
    }
  },
      ...
      "wordExplanations": [
        {
          ...
          "role": "Polite Introductory Question Frame",
          "whyUsed": "Softens the inquiry for professional and everyday polite social interaction."
        },
        {
          "word": "where the bank is",
          "role": "Embedded Indirect Noun Clause",
          "whyUsed": "Follows normal Subject (\"the bank\") + Verb (\"is\") order without double inversion."
        }
      ],
      ...
      "rules": [
        {
          ...
          "why": "Countable items exist as discrete countable units. Uncountable items exist as a continuous mass or abstract concept.",
        ...
        },
        {
          ...
          "why": "\"Some\" assumes or offers a positive non-zero quantity, whereas \"any\" checks for or asserts zero existence.",
        ...
        {
          "rule": "To count Uncountable Nouns, combine them with measuring units (e.g. \"a piece of advice\", \"a cup of tea\", \"a slice of bread\").",
          "why": "The measuring unit supplies the discrete countable container for the mass noun.",
          "example": "She gave me two valuable pieces of advice.",
          "wrongExample": "She gave me two valuable advices."
        }
      ],
      "wordExplanations": [
        {
          "word": "many chairs",
          "role": "Quantifier + Countable Plural Noun",
          "whyUsed": "\"Many\" modifies countable items that can take plural -s."
        },
        {
          "word": "much information",
          "role": "Quantifier + Uncountable Abstract Noun",
          "whyUsed": "\"Information\" is uncountable in standard English and takes \"much\" or \"a lot of\"."
        },
        {
          "word": "some water",
          "role": "Polite Offer / Mass Quantity",
          "whyUsed": "\"Some\" is used in positive contexts or polite offers."
        }
      ],
      "proTip": "In casual conversation, \"a lot of\" or \"lots of\" works naturally with BOTH countable and uncountable nouns (e.g., \"a lot of apples\", \"a lot of water\")!"
    },
    "quiz": [
      {
        "id": "d5-q1",
        ...
        "correctAnswerIndex": 0,
        "explanationWhy": "\"Luggage\" is an uncountable noun. To count individual items, we say \"pieces of luggage\" and use \"many\" to modify the plural noun \"pieces\".",
        "grammaticalRole": "Countable Quantifier with Mass Noun Counter"
      },
      {
        "id": "d5-q2",
        "question": "Why do we ask \"Would you like some tea?\" instead of \"Would you like any tea?\" when offering hospitality?",
        "options": [
          "Because \"some\" is used in polite offers where you expect or encourage a positive response.",
          "Because \"tea\" is a countable noun.",
          "Because \"any\" is grammatically illegal in questions.",
          "There is no difference in tone."
        ],
        "correctAnswerIndex": 0,
        "explanationWhy": "In hospitable offers and requests, \"some\" creates a warm, welcoming expectation of \"yes\", whereas \"any\" sounds neutral or doubt-filled.",
        "grammaticalRole": "Polite Offer Pragmatics with \"Some\""
      },
      {
        "id": "d5-q3",
        "question": "Select the correct sentence for negative quantity:",
        "options": [
          "We don't have any milk left in the refrigerator.",
          "We don't have some milk left in the refrigerator.",
          "We don't have many milk left in the refrigerator.",
          "We don't have a milk left in the refrigerator."
        ],
        "correctAnswerIndex": 0,
        "explanationWhy": "In negative statements (\"don't have\"), standard grammar uses \"any\" to denote zero quantity of an uncountable noun (\"milk\").",
        "grammaticalRole": "Negative Statement Quantifier \"Any\""
      }
    ],
    "miniGame": {
      "type": "sentence_builder",
      "title": "Quantifier & Noun Architect",
      "instructions": "Arrange the word blocks to build a grammatically accurate sentence!",
      "sentenceBuilder": [
        {
        ...
        {
          "targetSentence": "Do you have any questions about the assignment?",
          "wordPool": [
            "Do",
            "you",
            "have",
          ...
          "grammarBreakdown": "\"Any\" is used in general inquiries with plural countable nouns."
        }
      ]
    }
  },
      ...
      "wordExplanations": [
        {
          ...
          "role": "Partitive Measure Noun + Uncountable Noun",
          "whyUsed": "\"Advice\" cannot be pluralized with \"-s\", so \"a piece of\" creates a countable unit."
        },
        {
          "word": "a few options",
          "role": "Quantifier + Plural Countable Noun",
          "whyUsed": "\"A few\" indicates a positive small quantity of countable options."
        }
      ],
      ...
      "wordPairs": [
        {
          "id": "q1",
          "word": "Many / A few",
          "definitionOrSynonym": "Countable Plural Nouns (books, days, ideas)",
          "whyItMatters": "Used only for distinct unit items."
        },
        {
          "id": "q2",
          "word": "Much / A little",
          "definitionOrSynonym": "Uncountable Nouns (water, money, patience)",
          "whyItMatters": "Used for continuous non-unit items."
        }
      ]
    }
  },
  {
    ...
    "theory": {
      ...
      "wordExplanations": [
        {
          "word": "on Monday",
          "role": "Preposition of Specific Calendar Day",
          "whyUsed": "\"On\" is required for specific named calendar days."
        },
        {
          "word": "at 3 o'clock",
          "role": "Preposition of Precise Clock Time",
          "whyUsed": "\"At\" targets an exact pinpoint time on the clock."
        }
      ],
      ...
      "wordExplanations": [
        {
          ...
          "role": "Preposition + Gerund Verbal Noun",
          "whyUsed": "The preposition \"in\" requires the gerund form \"learning\"."
        },
        {
          "word": "decided to go",
          "role": "Verb of Intention + Full Infinitive",
          "whyUsed": "\"Decided\" looks forward to a future choice, requiring \"to go\"."
        }
      ],
  ...
  },
  {
    ...
    "theory": {
      ...
      "wordExplanations": [
        {
          "word": "confirmed that",
          "role": "Professional Reporting Verb + Conjunction",
          "whyUsed": "Adds precise executive clarity to reported statements."
        },
        {
          "word": "would attend",
          "role": "Backshifted Modal (will ➔ would)",
          "whyUsed": "Shifts future modal \"will\" back to match past reporting verb \"confirmed\"."
        }
      ],
  ...
  },
  {
    ...
    "theory": {
      ...
      "wordExplanations": [
        {
          "word": "have visited",
          "role": "Present Perfect (have + V3)",
          "whyUsed": "Emphasizes life experience up to the present moment without specifying a closed past date."
        },
        {
          "word": "visited",
          "role": "Past Simple",
          "whyUsed": "Refers to a specific completed trip in a closed past timeframe."
        }
      ],
  ...
  },
  {
    ...
    "theory": {
      ...
      "wordExplanations": [
        {
          "word": "was presenting",
          "role": "Past Continuous Ongoing Background Action",
          "whyUsed": "Shows an ongoing action in progress in the past."
        },
        {
          "word": "had already left",
          "role": "Past Perfect Earlier Completed Action",
          "whyUsed": "Proves the train departed before the speaker arrived."
        }
      ],
  ...
  },
  {
    ...
    "theory": {
      ...
      "wordExplanations": [
        {
          "word": "am meeting",
          "role": "Present Continuous for Fixed Future Arrangement",
          "whyUsed": "Confirms a time and location have already been booked."
        },
        {
          "word": "will help",
          "role": "Spontaneous Volitional Modal Choice",
          "whyUsed": "Offers help instantly at the moment of request."
        }
      ],
      ...
      "wordPairs": [
        {
          "id": "f1",
          "word": "Will + Base Verb",
          "definitionOrSynonym": "Spontaneous offers & instant decisions (\"I'll grab the door\")",
          "whyItMatters": "Decided at the moment of speech."
        },
        {
          "id": "f2",
          "word": "Be Going To",
          "definitionOrSynonym": "Prior intentions & evidence-based predictions",
          "whyItMatters": "Decided prior to the conversation."
        },
        {
          "id": "f3",
          "word": "Present Continuous",
          "definitionOrSynonym": "Fixed booked appointments (\"Meeting client at 2 PM\")",
          "whyItMatters": "Confirmed in calendar."
        }
      ]
    }
  },
  {
    ...
    "theory": {
      ...
      "wordExplanations": [
        {
          "word": "If I were",
          "role": "Subjunctive Mood Past Unreality",
          "whyUsed": "\"Were\" is used regardless of singular \"I\" to mark a purely hypothetical advice scenario."
        },
        {
          "word": "would buy",
          "role": "Modal Conditional Result",
          "whyUsed": "\"Would\" expresses the contingent hypothetical consequence."
        }
      ],
  ...
  },
  {
    ...
    "theory": {
      ...
      "wordExplanations": [
        {
          "word": "Not only did she",
          "role": "Emphatic Negative Fronting + Auxiliary Inversion",
          "whyUsed": "Elevates formal academic and executive prose style."
        }
      ],
  ...
  },
  {
    ...
    "theory": {
      ...
      "wordExplanations": [
        {
          "word": "was built",
          "role": "Passive Voice Past Simple (Be + V3)",
          "whyUsed": "Directs full attention to the landmark building rather than unknown ancient workers."
        }
      ],
    ...
    "miniGame": {
      ...
      "wordPairs": [
        {
          "id": "pv1",
          "word": "Active: \"The team completed the project.\"",
          "definitionOrSynonym": "Passive: \"The project was completed by the team.\"",
          "whyItMatters": "Shifts emphasis onto \"The project\"."
        },
        {
          "id": "pv2",
          "word": "Active: \"Someone stole my bike.\"",
          "definitionOrSynonym": "Passive: \"My bike was stolen.\"",
          "whyItMatters": "Agent is unknown, so \"was stolen\" is cleaner."
        }
      ]
    }
  },
  {
    ...
    "theory": {
      ...
      "wordExplanations": [
        {
          "word": "check it out",
          "role": "C-to-V Linked Phonetic Chain",
          "whyUsed": "Glides phonetically as /tʃek.ɪ.taʊt/ without pauses."
        },
        {
          "word": "gonna",
          "role": "Colloquial Spoken Phonetic Reduction",
          "whyUsed": "Natural spoken shorthand for \"going to\" in fluid conversation."
        }
      ],
      ...
      "wordPairs": [
        {
          ...
          "definitionOrSynonym": "Spoken Reductions: \"Gonna\" / \"Wanna\"",
          "whyItMatters": "Used in natural conversational flow."
        },
        {
          "id": "cs2",
          "word": "Should have / Could have",
          "definitionOrSynonym": "Spoken Reductions: \"Shoulda\" / \"Coulda\"",
          "whyItMatters": "Weakens auxiliary \"have\" to a neutral schwa."
        }
      ]
    }
  },
      ...
      "wordExplanations": [
        {
          ...
          "role": "Executive Hedging Frame",
          "whyUsed": "Presents observations objectively without personal bias."
        },
        {
          "word": "Having said that",
          "role": "Concessive Discourse Transition",
          "whyUsed": "Balances an optimistic point with necessary pragmatic caution."
        }
      ],
